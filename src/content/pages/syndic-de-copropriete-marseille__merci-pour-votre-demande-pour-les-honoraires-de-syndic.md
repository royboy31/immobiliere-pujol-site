...
seoTitle: "Merci pour votre demande"
seoDescription: "    Votre demande a bien été envoyée Nous allons vous rappeler au plus vite ! Suivez toute l'actualité immobilière en vous abonnant à la newsletter de notre blog L'équipe Syndic"
---

<section  class="hero hero__page hero--medium objectFitContainer" >
	<!-- Content -->
	<div class="hero__content">
    <h1 class="hero__title">Merci Pour Votre Demande</h1>        
