---
title: "Un marche immobilier à Marseille de début d’année sans entrain"
...
Jusque là tout va bien. Mais on ne sent pas l&rsquo;entrain ou la puissance d&rsquo;un nouveau cycle. La demande ne nous semble pas aussi forte qu&rsquo;habituellement dans cette phase de retournement du marché.
<h2>La Location</h2>
...
C’est bien, mais il n&rsquo;y a pas d&rsquo;accélération par rapport aux précédents trimestres.
...
Pour finir, espérons que les élections politiques ne vont pas troubler le marché par leurs projets farfelus des extrêmes qui font peur aux investisseurs, aux chefs d&rsquo;entreprises et à tous ceux qui souhaitent entreprendre. Le marché commence à peine à aller mieux&#8230;

                <div class='gf_browser_unknown gform_wrapper gform_legacy_markup_wrapper gform-theme--no-framework' data-form-theme='legacy' data-form-index='0' id='gform_wrapper_2' ><div id='gf_2' class='gform_anchor' tabindex='-1'></div>
                        <div class='gform_heading'>
                            <h3 class="gform_title">Newsletter</h3>
                            <p class='gform_description'>newsletter form</p>
                        </div><form method='post' enctype='multipart/form-data'  id='gform_2'  action='/analyse-marche-immobilier-marseille-2017/#gf_2' data-formid='2' novalidate>					<div style="display: none !important;" class="akismet-fields-container gf_invisible" data-prefix="ak_">
