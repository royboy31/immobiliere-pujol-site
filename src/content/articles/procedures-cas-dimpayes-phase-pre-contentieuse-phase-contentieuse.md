---
title: "Procédures en cas d'impayés : la phase pré contentieuse & la phase contentieuse"
slug: "procedures-cas-dimpayes-phase-pre-contentieuse-phase-contentieuse"
date: "2017-02-18"
...
<h2>La phase pré contentieuse</h2>
La phase pré contentieuse est la phase au cours de laquelle nous allons relancer amiablement le locataire pour l’emmener à régler.

Nous procédons le plus souvent selon au schéma suivant :
<ul>
 	<li>Le 15 du mois, relance simple (et/ou RAR) par courrier / ou par mail, rappelant au locataire les termes de ses obligations financières indiquées dans le bail. Ce processus de relance est généralement automatisé. Ces relances sont faites à l’attention du locataire, mais aussi des garants (le cas échéant).</li>
 	<li>Relance téléphonique au locataire (et /ou garant).</li>
 	<li>Dans certains cas passage sur les lieux loués (non systématique).</li>
</ul>
A ce stade, la plupart des impayés sont réglés à la fin du mois, mais il peut être convenu d’un commun accord avec le locataire de mettre en place un échéancier, un étalement de la dette sur les mois qui suivent (mais Il est important de ne pas se laisser embarquer dans échéanciers trop longs, le locataire devant comprendre que s’il a des difficultés,  le propriétaire peut également avoir des impératifs financiers dont dépend le paiement des loyers. Il faut trouver un juste milieu pour que tout le monde s’y retrouve.
